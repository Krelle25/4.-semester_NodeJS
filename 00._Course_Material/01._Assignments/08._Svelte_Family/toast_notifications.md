...
**Hand-in**: No hand in required since this will be part of mandatory II and thus part of the exam project.

Alerts are banned for the exam project. Learn how to set up toast notifications instead. 
